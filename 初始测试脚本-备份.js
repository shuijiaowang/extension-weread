...
const t=document.querySelector(".wr_underline_wrapper").parentElement.parentElement.querySelectorAll(":scope > div")[0] //评论触发点，文章画线的句子
t.querySelector(".wr_underline_wrapper").click() //点击触发评论
...
c.scrollBy(0,1000) //滚动加载，重复三次，先滚动，后爬取内容。
